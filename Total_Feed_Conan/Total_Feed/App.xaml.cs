...
using AppboyUI.Phone.Factories;
using Total_Feed.AppboyClasses;
...
namespace Total_Feed
{
    public partial class App : Application
    {
        ...
        public static bool Bool_Back = false;
        public static ObservableCollection<Character> Items = new ObservableCollection<Character>();
        public static ItemView Item_Current = new ItemView();
        public static bool Bool_Load = false;
        ...
        void LoadItems()
        {
            Items.Add(new Character("Itachi Uchiha"));
            Items.Add(new Character("Sasuke Uchiha"));
            Items.Add(new Character("Shisui Uchiha"));
            Items.Add(new Character("Madara Uchiha"));
            Items.Add(new Character("Obito Uchiha"));
        }
