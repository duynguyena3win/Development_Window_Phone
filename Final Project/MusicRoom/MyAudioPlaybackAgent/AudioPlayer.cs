...
namespace MyAudioPlaybackAgent
{
    public class AudioPlayer : AudioPlayerAgent
    {
        ...
        private List<AudioTrack> _playList = new List<AudioTrack>
        {
            // A remote URI
            new AudioTrack(new Uri("http://download.s72.stream.nixcdn.com/fc966ff4024e69a0f7f8c43573b09809/52d39bc0/NhacCuaTui229/Em-HongDuongM4U_46kdb.mp3", UriKind.Absolute), 
                            "Episode 29", 
                            "Windows Phone Radio", 
