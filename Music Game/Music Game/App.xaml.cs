...
namespace Music_Game
{
    public partial class App : Application
    {
        ...
        public static MobileServiceClient MobileService = new MobileServiceClient(
                "https://musicgame.azure-mobile.net/",
                "cCuPvJLinSychIxcnEMCHQkrEQOBKr94"
        );
        ...
        {
            CurrentChannel = HttpNotificationChannel.Find("PushChannel");
            if (CurrentChannel == null)
            {
                CurrentChannel = new HttpNotificationChannel("PushChannel");
                CurrentChannel.Open();
    ...
    class Constants
    {
        public static readonly string FacebookAppId = "1537337169864138";
    }
}